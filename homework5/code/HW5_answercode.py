...
outputpath = r'C:\Users\brewe\Dropbox\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2023-db\homework5\output'
...
hw5output3 = hw5output3.append(pd.DataFrame([[str(nobsa),str(nobsb),str(nobsc)], [fstata,fstatb,fstatc]], index = ['Observations', 'First stage F'], columns = ['(a)', '(b)','(c)']))
