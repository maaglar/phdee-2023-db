...
datapath = r'C:\Users\brewe\Dropbox\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2023-db\homework4'
outputpath = r'C:\Users\brewe\Dropbox\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2023-db\homework4\output'
...
DID3a = sm.OLS(yvar3a,sm.add_constant(xvar3a, prepend = False)).fit()
...
DID3b = sm.OLS(yvar3b,sm.add_constant(xvar3b,prepend = False)).fit()
...
DID3c = sm.OLS(yvar3c,sm.add_constant(xvar3c,prepend = False)).fit()
