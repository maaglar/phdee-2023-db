...
datapath = r'C:\Users\brewe\Dropbox\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2023-db\homework5'
outputpath = r'C:\Users\brewe\Dropbox\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2023-db\homework6\output'
...
plt.savefig('hw6q3.pdf',format='pdf')
plt.show()
...
plt.savefig('hw6q4.pdf',format='pdf')
plt.show()
...
plt.savefig('hw6q5.pdf',format='pdf')
plt.show()
...
hw6output6 = pd.DataFrame(pd.concat([beta,cis],axis = 1).stack())
hw6output6.columns = ['Question 6']
hw6output6.index = ['Sedan',' ','MPG','','Constant','']
hw6output6 = hw6output6.append(pd.DataFrame([str(ivest.nobs)],index = ['Observations'],columns = ['Question 6']))

hw6output6.to_latex('hw6output6.tex',column_format = 'lc', na_rep = ' ')
